...
class BEVRender(BaseRender):
    ...
    def render_hd_map(self, nusc, nusc_maps, sample_token):
        ...
        map_show[map_mask[0], :] = np.array([255./255., 242./255., 202./255.])
        map_show[map_mask[1], :] = np.array([254./255., 217./255., 97./255.])
        self.axes.imshow(map_show, alpha=0.8, interpolation='nearest',
