...
from .expert_uniad_track import ExpertUniADTrack
from mmdet.models.builder import build_head
import torch.distributed as dist
import time

@DETECTORS.register_module()
class ExpertUniAD(ExpertUniADTrack):
    """
    ExpertUniAD: Unifying Detection, Tracking, Segmentation, Motion Forecasting, Occupancy Prediction and Planning for Autonomous Driving
    """
    def __init__(
        self,
        seg_head=None,
        ...
        **kwargs,
        ...
        super(ExpertUniAD, self).__init__(**kwargs)
        if seg_head:
    ...
    def forward_train(self,
        ...
        if self.with_motion_head:
            ret_dict_motion = self.motion_head.forward_train(bev_embed,
                                                        ...
                                                        velocity, acceleration, yaw, command, 
    ...
    def forward_test(self,
        ...
        if self.with_motion_head:
            result_motion, outs_motion = self.motion_head.forward_test(bev_embed, velocity, acceleration, yaw, command, outs_track=result_track[0], outs_seg=result_seg[0])
