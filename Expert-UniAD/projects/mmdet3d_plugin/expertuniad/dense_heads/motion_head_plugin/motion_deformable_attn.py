...
from projects.mmdet3d_plugin.expertuniad.modules.multi_scale_deformable_attn_function import MultiScaleDeformableAttnFunction_fp32
...
class MotionDeformableAttention(BaseModule):
    ...
    def forward(self,
        ...
        bs = 1
        num_agent, num_mode, _ = query.shape
