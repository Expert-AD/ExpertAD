...
model = dict(
    ...
    motion_head=dict(
        ...
        anchor_info_path='others/motion_anchor_infos_mode6.pkl',
        transformerlayers=dict(
            ...
            batch_first=True,
            experts_layers=dict(
                type='MoATransformerInteraction',
                num_experts=8,
                embed_dims=_dim_,
                batch_first=True,
                k=4,
                ...
                experts=[
                    dict(
                        ...
                        dropout=0.1,
                        batch_first=True,
                        sparse_att='BlockSparseAttention'
                    ),
                    dict(
                        type='MapInteraction',
                        embed_dims=256,
                    ...
                    dict(
                        type='VelocityInteraction',
                        embed_dims=256,
                        num_heads=8,
                        dropout=0.1,
                        batch_first=True,
                        sparse_att='SlidingWindowAttention'
                    ),
                    dict(
                        type='AccelerationInteraction',
                        embed_dims=256,
                        num_heads=8,
                        dropout=0.1,
                        batch_first=True,
                    ...
                    dict(
                        type='ReferencePointInteraction',
                        embed_dims=256,
                        num_heads=8,
                        dropout=0.1,
                        batch_first=True,
                        sparse_att='GlobalSparseAttention'
                    ),
                    dict(
...
ann_file_train = "data/info/nuscenes_infos_train_ego.pkl"
ann_file_val = 'data/info/nuscenes_infos_val_ego.pkl'
ann_file_test = 'data/info/nuscenes_infos_val_ego.pkl'
