...
BASE_TM_PORT=50000
IS_BENCH2DRIVE=True
BASE_ROUTES=leaderboard/data/bench2drive10
TEAM_AGENT=team_code/uniad_b2d_agent.py
# Must set YOUR_CKPT_PATH
TEAM_CONFIG=Bench2DriveZoo/adzoo/uniad/configs/stage2_e2e/tiny_e2e_b2d.py+Bench2Drive/Bench2DriveZoo/ckpts/tiny_e2e_b2d.pth
BASE_CHECKPOINT_ENDPOINT=eval_bench2drive10
PLANNER_TYPE=moe
ALGO=uniad_tiny
SAVE_PATH=./eval_bench2drive10_${ALGO}_${PLANNER_TYPE}
...
if [ ! -f "${BASE_ROUTES}_${ALGO}_${PLANNER_TYPE}_split_done.flag" ]; then
    ...
    TASK_NUM=9 # 8*H100, 1 task per gpu
