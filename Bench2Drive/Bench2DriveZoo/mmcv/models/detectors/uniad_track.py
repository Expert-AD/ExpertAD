...
from ..dense_heads.track_head_plugin import MemoryBank, QueryInteractionModule, Instances, RuntimeTrackerBase, Adapter
...
class UniADTrack(MVXTwoStageDetector):
    ...
    def __init__(
        ...
        self.track_adapter = Adapter(epsilon=0.001, T=100)
