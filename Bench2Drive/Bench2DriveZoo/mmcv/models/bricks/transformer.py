...
if 'MultiScaleDeformableAttention' not in ATTENTION._module_dict:
    ATTENTION.register_module(name='MultiScaleDeformableAttention', module=MultiScaleDeformableAttention)
