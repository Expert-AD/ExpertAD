...
from mmcv.models.builder import register_custom_bbox_coders
...
class VADv2Head(DETRHead):
    ...
    def __init__(self,
        ...
        self.plan_anchors = np.load(plan_anchors_path, allow_pickle=True)
        ...
        if map_class_weight is not None and (self.__class__ is VADv2Head):
        ...
        super(VADv2Head, self).__init__(*args, transformer=transformer, **kwargs)
