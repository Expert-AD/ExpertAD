...
model = dict(
    ...
    pts_bbox_head=dict(
        ...
        transformer=dict(
            type='ExpertVADPerceptionTransformer',
            map_num_vec=map_num_vec,
            map_num_pts_per_vec=map_fixed_ptsnum_per_pred_line,
...
info_train='infos/vad_nuscenes_infos_temporal_train_ego.pkl'
info_test='infos/vad_nuscenes_infos_temporal_val_ego.pkl'
