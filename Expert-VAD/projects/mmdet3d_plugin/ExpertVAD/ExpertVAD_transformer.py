...
from projects.mmdet3d_plugin.ExpertVAD.modules.decoder import CustomMSDeformableAttention
from projects.mmdet3d_plugin.ExpertVAD.modules.temporal_self_attention import TemporalSelfAttention
from projects.mmdet3d_plugin.ExpertVAD.modules.spatial_cross_attention import MSDeformableAttention3D
...
class ExpertVADPerceptionTransformer(BaseModule):
    ...
    def __init__(self,
                 ...
                 **kwargs):
        super(ExpertVADPerceptionTransformer, self).__init__(**kwargs)
