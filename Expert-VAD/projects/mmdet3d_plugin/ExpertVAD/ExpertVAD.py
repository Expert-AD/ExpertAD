...
from projects.mmdet3d_plugin.ExpertVAD.planner.metric_stp3 import PlanningMetric


@DETECTORS.register_module()
class ExpertVAD(MVXTwoStageDetector):
    """ExpertVAD model.
    """
    def __init__(self,
                 use_grid_mask=False,
    ...
    def forward_pts_train(self,
        ...
        """
        # print('ExpertVAD velocity: ',velocity)
        # print('ExpertVAD acc: ',acceleration)
        # print('ExpertVAD yaw: ',yaw)
        outs = self.pts_bbox_head(pts_feats, img_metas, prev_bev,
                                  ego_his_trajs=ego_his_trajs, ego_lcf_feat=ego_lcf_feat,
                                  velocity=velocity, acceleration=acceleration,yaw=yaw)
        loss_inputs = [
